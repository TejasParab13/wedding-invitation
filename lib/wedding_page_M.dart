...
class WeddingPageM extends StatefulWidget {
  const WeddingPageM({super.key});

  @override
  State<WeddingPageM> createState() => _WeddingPageMState();
}

class _WeddingPageMState extends State<WeddingPageM>
          ...
          child: _AnimationScope(
            ...
            child: Stack(
              children: [
                ...
                const RepaintBoundary(child: FallingPetals(density: 1)),
                Positioned.fill(
